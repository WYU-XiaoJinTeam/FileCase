...
(this, function ($) {
    ...
    Ssi_upload.prototype.init = function (element) {
        $(element).addClass('ssi-uploadInput')//element=<inout type="file" id="ssi-upload"/>
        ...
        var $chooseBtn = $('' +
         ...
         '</span>').append(element);//将<input type="file" class="ssi-uploadInput">放到<span class="ssi=InputLabel"/>内部
		...
		//在<div class="ssi-buttonWrapper">内部添加($chooseBtn, $abortBtn, $uploadBtn, $clearBtn)
